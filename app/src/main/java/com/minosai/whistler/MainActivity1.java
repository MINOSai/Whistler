...
////                addNotification();
//                Intent intent = new Intent(MainActivity1.this, ContactDetails.class);
//                intent.putExtra("userEmailId",userMailId);
//                Toast.makeText(MainActivity1.this, "Before intent put extra: "+userMailId, Toast.LENGTH_SHORT).show();
        ...
        authStateListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if(firebaseUser != null){
                    ...
                    Toast.makeText(MainActivity1.this, firebaseUser.getEmail().replace(".",""), Toast.LENGTH_SHORT).show();
